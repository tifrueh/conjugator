...
class QuizItem {
    public:
        ...
        QuizItem(wxWindow* parent, wxFlexGridSizer* sizer, const cjgt::QuizItem& data, const bool& translate = false);

        // Set the focus to the text control.
        void SetFocus();

        // Reset the verb form this quiz item should ask for.
        void setQuizData(const cjgt::QuizItem& data, const bool& translate = false);
